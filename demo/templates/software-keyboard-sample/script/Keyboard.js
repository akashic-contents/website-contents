...
class Keyboard extends g.E {
    ...
    constructor(param) {
        super(param);
        const kanaReader = new SpriteReader_1.SpriteReader(param.scene, "/text/hint_key_kana.json", "/image/img_key_kana.png");
        ...
        const inputtingLabelBackAsset = this.sceneAssets.getImage("/image/inputtingLabelBack.png");
