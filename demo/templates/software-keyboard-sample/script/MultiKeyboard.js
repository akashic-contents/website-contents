...
class MultiKeyboard extends Keyboard_1.Keyboard {
    ...
    constructor(param) {
        super(param);
        const alphaReader = new SpriteReader_1.SpriteReader(param.scene, "/text/hint_key_alpha.json", "/image/img_key_alpha.png");
        const symReader = new SpriteReader_1.SpriteReader(param.scene, "/text/hint_key_sym.json", "/image/img_key_sym.png");
