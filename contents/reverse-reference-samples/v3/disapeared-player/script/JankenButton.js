...
var JankenButton = /*#__PURE__*/function (_g$Sprite) {
  function JankenButton(param) {
    _classCallCheck(this, JankenButton);
    return _callSuper(this, JankenButton, [param]);
  }
  _inherits(JankenButton, _g$Sprite);
  return _createClass(JankenButton);
}(g.Sprite);
